        ...
        public ReturnedData GetRate(decimal amount) {
            ...
            if (decimal.TryParse(ratefromWeb, out finalRate)) {
                return new ReturnedData() {
                    ProviderName = "<a href=\"http://www.timesofmoney.com/remittance/jsp/r2iExchRateCalculator.jsp?uiId=TOML&sendercountry=US&sendercurrency=USD\" target=\"_blank\">Remit 2 India</a>",
                    Rate = finalRate,
